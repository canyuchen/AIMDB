...
def checks (aim_dir, post_dir):
    ...
    total = len (post)
    aim = 0
    test_set = [3,4,5,8,9,10,12,13,14,15,17,19,20,22]
...
if __name__ == '__main__':
    os.system('cp ./reference/runaimdb_n.cc ../AIMDB/system/runaimdb.cc')
    os.chdir ('../AIMDB/')
    os.system('make')
    os.chdir ('../Lab3_Test2/')
    os.system('../AIMDB/runaimdb ./data/tpch_schema_r.txt ./data/sf100Mt/')
